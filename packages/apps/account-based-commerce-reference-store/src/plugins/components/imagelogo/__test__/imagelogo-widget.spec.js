...
export const imagelogo = () => import('../index');

describe('imagelogo renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {imagelogo};
  beforeAll(async () => {
    /**
  ...
  it('imagelogo works as expected', async () => {
    /**
