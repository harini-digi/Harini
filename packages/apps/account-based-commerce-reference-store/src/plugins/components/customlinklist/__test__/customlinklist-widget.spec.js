...
export const customlinklist = () => import('../index');

describe('customlinklist renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {customlinklist};
  beforeAll(async () => {
    /**
  ...
  it('customlinklist works as expected', async () => {
    /**
