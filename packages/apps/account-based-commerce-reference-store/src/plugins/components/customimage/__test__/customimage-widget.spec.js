...
export const customimage = () => import('../index');

describe('customimage renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {customimage};
  beforeAll(async () => {
    /**
  ...
  it('customimage works as expected', async () => {
    /**
