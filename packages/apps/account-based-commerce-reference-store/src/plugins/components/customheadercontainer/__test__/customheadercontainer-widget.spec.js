...
export const customheadercontainer = () => import('../index');

describe('customheadercontainer renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {customheadercontainer};
  beforeAll(async () => {
    /**
  ...
  it('customheadercontainer works as expected', async () => {
    /**
    ...
    const state = {
      pageRepository: {
        widgets: {
          dsWidgetInstance: {
            id: 'dsWidgetInstance',
            componentId: 'customheadercontainer',
            regions: []
          }
        }
      }
